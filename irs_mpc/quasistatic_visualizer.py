...
class QuasistaticVisualizer:
    ...
    def calc_body_id_to_contact_force_map(self, contact_results: ContactResults):
        """
    ...
    def calc_contact_forces_knots_map(self, contact_results_list: List[ContactResults]):
        """
        ...
        for t, contact_results in enumerate(contact_results_list):
            contact_forces_map = self.calc_body_id_to_contact_force_map(contact_results)
    ...
    def render_trajectory(
        ...
        if contact_results_list:
            cf_knots_map = self.calc_contact_forces_knots_map(contact_results_list)
            cf_knots_map_reduced = self.concatenate_contact_forces(cf_knots_map, stride)

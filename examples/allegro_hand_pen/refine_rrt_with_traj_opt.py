...
std_u_initial[0: 3] = 0.03
impc_params.std_u_initial = std_u_initial
impc_params.num_samples = 100
# analytic bundling
impc_params.log_barrier_weight_initial = 50
log_barrier_weight_final = 100
max_iterations = 10

base = np.log(
    log_barrier_weight_final / impc_params.log_barrier_weight_initial) \
       / max_iterations
base = np.exp(base)

...
from pydrake.all import (LeafSystem, Meshcat, DrakeLcm, AbstractValue,
...
if __name__ == "__main__":
    drake_lcm = DrakeLcm()
    initial_msg = wait_for_msg(channel_name=kOptitrackChannelName,
    ...
    builder.Connect(optitrack_sub.get_output_port(0),
                    state_estimator.optitrack_input_port)

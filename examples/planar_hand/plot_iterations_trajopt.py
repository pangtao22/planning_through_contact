...
filename_array = [
    "data/planar_hand/trajopt/noreject/tree_100_planar_hand_to_noreject_1.pkl",
    "data/planar_hand/trajopt/noreject/tree_100_planar_hand_to_noreject_2.pkl",
    "data/planar_hand/trajopt/noreject/tree_100_planar_hand_to_noreject_3.pkl",
    "data/planar_hand/trajopt/noreject/tree_100_planar_hand_to_noreject_4.pkl",
    "data/planar_hand/trajopt/noreject/tree_100_planar_hand_to_noreject_5.pkl",                
]
...
"""
filename_array = [
    "data/planar_hand/trajopt/ours/tree_100_planar_hand_to_1.pkl",
    "data/planar_hand/trajopt/ours/tree_100_planar_hand_to_2.pkl",
    "data/planar_hand/trajopt/ours/tree_100_planar_hand_to_3.pkl",
    "data/planar_hand/trajopt/ours/tree_100_planar_hand_to_4.pkl",
    "data/planar_hand/trajopt/ours/tree_100_planar_hand_to_5.pkl",
]
plot_filename_array(filename_array, 'springgreen', 'iRS-RRT')
"""

filename_array = [
    "data/planar_hand/trajopt/global/tree_100_planar_hand_to_global_1.pkl",
    "data/planar_hand/trajopt/global/tree_100_planar_hand_to_global_2.pkl",
    "data/planar_hand/trajopt/global/tree_100_planar_hand_to_global_3.pkl",
    "data/planar_hand/trajopt/global/tree_100_planar_hand_to_global_4.pkl",
    "data/planar_hand/trajopt/global/tree_100_planar_hand_to_global_5.pkl",
]
plot_filename_array(filename_array, 'red', 'Global Metric')

filename_array = [
    "data/planar_hand/trajopt/nocontact/tree_100_planar_hand_to_nocontact_1.pkl",
    "data/planar_hand/trajopt/nocontact/tree_100_planar_hand_to_nocontact_2.pkl",
    "data/planar_hand/trajopt/nocontact/tree_100_planar_hand_to_nocontact_3.pkl",
    "data/planar_hand/trajopt/nocontact/tree_100_planar_hand_to_nocontact_4.pkl",
    "data/planar_hand/trajopt/nocontact/tree_100_planar_hand_to_nocontact_5.pkl",
]

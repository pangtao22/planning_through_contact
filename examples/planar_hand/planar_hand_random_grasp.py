...
contact_sampler = PlanarHandContactSampler(q_dynamics, 100, 0.5)
...
contact_sampler.sample_contact(q_u0)

joint_limits = {
    idx_u: np.array([[-0.2, 0.2], [0.4, 0.5], [-0.01, np.pi]]),
...
params.global_metric = np.array([0.1, 0.1, 0.1, 0.1, 100.0, 100.0, 1.0])

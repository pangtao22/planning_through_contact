...
fig = go.Figure(
    data=[plot_1_step, plot_trj, plot_qu0] + principal_axes_plots, layout=layout
)
...
app.layout = dbc.Container(
    [
        dbc.Row(
            [
                dbc.Col(
                    dcc.Graph(id="reachable-sets", figure=fig),
...
@app.callback(
    Output("selected-data", "children"), Input("reachable-sets", "selectedData")
)
...
@app.callback(
    Output("relayout-data", "children"), Input("reachable-sets", "relayoutData")
)

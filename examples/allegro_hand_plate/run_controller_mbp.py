...
def create_allegro_controller_plant(gravity: np.ndarray):
    ...
    ProcessModelDirectives(
        LoadModelDirectives(os.path.join(models_dir, "allegro_hand_plate.yml")),
        plant,
        parser,
    )
...
file_path = "examples/allegro_hand_plate/plate_optimized_q_and_u_trj_3.pkl"
...
log_dict = {
    ...
    "q_u_ref"    : np.array(q_u_ref_mat), # q_u ref trajectory,
...
data_index = 9
filename = "ptc_data/allegro_hand_plate/sim2real/{:02d}.pkl".format(data_index)

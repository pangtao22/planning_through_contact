...
filename_array = [
    "data/plate/project/ours/tree_700_1.pkl",
    "data/plate/project/ours/tree_700_2.pkl",
    "data/plate/project/ours/tree_700_3.pkl",
    "data/plate/project/ours/tree_700_4.pkl",
    "data/plate/project/ours/tree_700_5.pkl",                
]
plot_filename_array(filename_array, 'springgreen', 'iRS-RRT')

filename_array = [
    "data/plate/project/global/tree_700_1.pkl",
    "data/plate/project/global/tree_700_2.pkl",
    "data/plate/project/global/tree_700_3.pkl",
    "data/plate/project/global/tree_700_4.pkl",
    "data/plate/project/global/tree_700_5.pkl",
]
plot_filename_array(filename_array, 'red', 'Global Metric')

filename_array = [
    "data/plate/project/nocontact/tree_700_1.pkl",
    "data/plate/project/nocontact/tree_700_2.pkl",
    "data/plate/project/nocontact/tree_700_3.pkl",
    "data/plate/project/nocontact/tree_700_4.pkl",
    "data/plate/project/nocontact/tree_700_5.pkl",
]

...
def compute_statistics(filename):
    ...
    def sampling_function(n_samples):
        ...
        rpy_random[:,0] = -0.1 + (np.pi/2 + 0.2) * rpy_random[:,0]
        rpy_random[:,1] = -0.2 + 0.4 * rpy_random[:,1]
        rpy_random[:,2] = -0.2 + 0.4 * rpy_random[:,2]
        ...
        samples[:,23] = -0.1 + 0.2 * samples[:,4]
        samples[:,24] = -0.5 + 0.2 * samples[:,5]
        samples[:,25] = 0.3 * samples[:,6]
        return samples
...
def plot_filename_array(filename_array, color, label):
    ...
    for filename in filename_array:
        ...
        cost_array_lst.append(
            np.pad(cost_array, (0, 50-len(cost_array)), mode='edge'))
        packing_ratio_lst.append(
            np.pad(packing_ratio_array, (0, 50-len(cost_array)), mode='edge'))
...
filename_array = [
    "data/plate/trajopt/ours/tree_50_1.pkl",
    "data/plate/trajopt/ours/tree_50_2.pkl",
    "data/plate/trajopt/ours/tree_50_3.pkl",
    "data/plate/trajopt/ours/tree_50_4.pkl",
    "data/plate/trajopt/ours/tree_50_5.pkl",                
]
plot_filename_array(filename_array, 'springgreen', 'iRS-RRT')

filename_array = [
    "data/plate/trajopt/global/tree_50_1.pkl",
    "data/plate/trajopt/global/tree_50_2.pkl",
    "data/plate/trajopt/global/tree_50_3.pkl",
    "data/plate/trajopt/global/tree_50_4.pkl",
    "data/plate/trajopt/global/tree_50_5.pkl",
]
plot_filename_array(filename_array, 'red', 'Global Metric')

filename_array = [
    "data/plate/trajopt/nocontact/tree_50_1.pkl",
    "data/plate/trajopt/nocontact/tree_50_2.pkl",
    "data/plate/trajopt/nocontact/tree_50_3.pkl",
    "data/plate/trajopt/nocontact/tree_50_4.pkl",
    "data/plate/trajopt/nocontact/tree_50_5.pkl",
]
